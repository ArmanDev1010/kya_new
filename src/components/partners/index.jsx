  ...
  return (
    <div className="partners relative z-[0] w-full h-[65vh] bg-[linear-gradient(#fce6e7,#ffff)] mt-[60px]">
      <div className="grid grid-cols-2 px-[3%] pt-[50px] pb-[65px] pointer-events-none">
        ...
        <div className="">
          <div className="text-[1.3vw] leading-[1.2] tracking-[-0.04em] mt-[1rem] mb-[1.5rem] max-_1600:leading-[1.4]">
            <p className="w-[29vw]">
              Our partners help bridge the gap between learning and real-world
              experience. Through visits, mentorship, and collaboration, they
              empower our students to explore bold ideas and turn their
